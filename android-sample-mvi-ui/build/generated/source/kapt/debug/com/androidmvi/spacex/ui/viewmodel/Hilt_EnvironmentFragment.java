...
abstract class Hilt_EnvironmentFragment<T extends ViewBinding> extends BaseFragment<T> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EnvironmentFragment_GeneratedInjector) this.generatedComponent()).injectEnvironmentFragment(UnsafeCasts.<EnvironmentFragment>unsafeCast(this));
    }
  }
