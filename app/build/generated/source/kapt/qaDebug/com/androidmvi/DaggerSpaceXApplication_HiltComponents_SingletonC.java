...
import com.androidmvi.spacex.ui.injection.ViewModuleInjects_EnvironnmentViewModelFactory;
...
import com.androidmvi.spacex.ui.viewmodel.EnvironmentFragment_MembersInjector;
...
public final class DaggerSpaceXApplication_HiltComponents_SingletonC extends SpaceXApplication_HiltComponents.SingletonC {
  ...
  private volatile Provider<ViewModel> environnmentViewModelProvider;
  ...
  private QaApiUrlConfig qaApiUrlConfig() {
    return new QaApiUrlConfig(new Server());
  }
  ...
  private OkHttpClient okHttpClient() {
    ...
    if (local instanceof MemoizedSentinel) {
      synchronized (local) {
        local = okHttpClient;
        if (local instanceof MemoizedSentinel) {
          local = NetworkModule_GetOkHttpClientFactory.getOkHttpClient(qaApiUrlConfig(), sharedPreferences(), ApplicationContextModule_ProvideContextFactory.provideContext(applicationContextModule));
  ...
  private Provider<ViewModel> environnmentViewModelProvider() {
    Object local = environnmentViewModelProvider;
    if (local == null) {
      local = new SwitchingProvider<>(singletonC, 2);
      environnmentViewModelProvider = (Provider<ViewModel>) local;
    }
    return (Provider<ViewModel>) local;
  }
    ...
    private static final class ActivityCImpl extends SpaceXApplication_HiltComponents.ActivityC {
      ...
      private static final class FragmentCI extends SpaceXApplication_HiltComponents.FragmentC {
        ...
        private Map<Class<? extends ViewModel>, Provider<ViewModel>> mapOfClassOfAndProviderOfViewModel(
          ...
          return MapBuilder.<Class<? extends ViewModel>, Provider<ViewModel>>newMapBuilder(3).put(RocketListViewModel.class, singletonC.rocketListViewModelProvider()).put(RocketDetailsViewModel.class, singletonC.rocketDetailsViewModelProvider()).put(EnvironnmentViewModel.class, singletonC.environnmentViewModelProvider()).build();
        }
        ...
        @Override
        public void injectEnvironmentFragment(EnvironmentFragment arg0) {
          injectEnvironmentFragment2(arg0);
        }
        ...
        private EnvironmentFragment injectEnvironmentFragment2(EnvironmentFragment instance) {
          EnvironmentFragment_MembersInjector.injectMPreference(instance, singletonC.sharedPreferences());
          EnvironmentFragment_MembersInjector.injectMCustomViewModelFactory(instance, customViewModelFactory());
          return instance;
        }
  ...
  private static final class SwitchingProvider<T> implements Provider<T> {
    ...
    public T get() {
      switch (id) {
        ...
        case 2: // java.util.Map<java.lang.Class<? extends androidx.lifecycle.ViewModel>,javax.inject.Provider<androidx.lifecycle.ViewModel>> com.androidmvi.spacex.ui.injection.ViewModuleInjects#environnmentViewModel 
        return (T) ViewModuleInjects_EnvironnmentViewModelFactory.environnmentViewModel();
